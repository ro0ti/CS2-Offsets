...
public static class CCSPlayerController {
    ...
    public const nint m_iRoundsWon = 0x824; // int32
...
public static class CCSPlayerPawn {
    ...
    public const nint m_nCharacterDefIndex = 0x1578; // uint16
    ...
    public const nint m_iRetakesOffering = 0x1660; // int32
    public const nint m_iRetakesOfferingCard = 0x1664; // int32
    public const nint m_bRetakesHasDefuseKit = 0x1668; // bool
    public const nint m_bRetakesMVPLastRound = 0x1669; // bool
    public const nint m_iRetakesMVPBoostItem = 0x166C; // int32
    ...
    public const nint m_flLandseconds = 0x1678; // float32
    public const nint m_aimPunchAngle = 0x167C; // QAngle
    public const nint m_aimPunchAngleVel = 0x1688; // QAngle
    public const nint m_aimPunchTickBase = 0x1694; // int32
    public const nint m_aimPunchTickFraction = 0x1698; // float32
    ...
    public const nint m_iPlayerLocked = 0x1C38; // int32
    ...
    public const nint m_nRagdollDamageBone = 0x1C4C; // int32
...
public static class CCSPlayerPawnBase {
    ...
    public const nint m_flNameChangeHistory = 0xD4C; // float32[5]
    public const nint m_fLastGivenDefuserTime = 0xD60; // float32
    public const nint m_fLastGivenBombTime = 0xD64; // float32
    public const nint m_bHasNightVision = 0xD68; // bool
    public const nint m_bNightVisionOn = 0xD69; // bool
    public const nint m_fNextRadarUpdateTime = 0xD6C; // float32
    public const nint m_flLastMoneyUpdateTime = 0xD70; // float32
    public const nint m_MenuStringBuffer = 0xD74; // char[1024]
    public const nint m_fIntroCamTime = 0x1174; // float32
    public const nint m_nMyCollisionGroup = 0x1178; // int32
    public const nint m_bInNoDefuseArea = 0x117C; // bool
    public const nint m_bKilledByTaser = 0x117D; // bool
    public const nint m_iMoveState = 0x1180; // int32
    ...
    public const nint m_nWhichBombZone = 0x1200; // int32
    public const nint m_bInBombZoneTrigger = 0x1204; // bool
    public const nint m_bWasInBombZoneTrigger = 0x1205; // bool
    public const nint m_iDirection = 0x1208; // int32
    public const nint m_iShotsFired = 0x120C; // int32
    public const nint m_ArmorValue = 0x1210; // int32
    public const nint m_flFlinchStack = 0x1214; // float32
    public const nint m_flVelocityModifier = 0x1218; // float32
    public const nint m_flHitHeading = 0x121C; // float32
    public const nint m_nHitBodyPart = 0x1220; // int32
    public const nint m_iHostagesKilled = 0x1224; // int32
    public const nint m_vecTotalBulletForce = 0x1228; // Vector
    public const nint m_flFlashDuration = 0x1234; // float32
    public const nint m_flFlashMaxAlpha = 0x1238; // float32
    public const nint m_flProgressBarStartTime = 0x123C; // float32
    public const nint m_iProgressBarDuration = 0x1240; // int32
    public const nint m_bWaitForNoAttack = 0x1244; // bool
    public const nint m_flLowerBodyYawTarget = 0x1248; // float32
    public const nint m_bStrafing = 0x124C; // bool
    public const nint m_lastStandingPos = 0x1250; // Vector
    public const nint m_ignoreLadderJumpTime = 0x125C; // float32
    ...
    public const nint m_flSlopeDropOffset = 0x129C; // float32
    public const nint m_flSlopeDropHeight = 0x12A0; // float32
    ...
    public const nint m_nNumDangerZoneDamageHits = 0x12E8; // int32
    ...
    public const nint m_nLastConcurrentKilled = 0x12F4; // int32
    public const nint m_nDeathCamMusic = 0x12F8; // int32
    public const nint m_iAddonBits = 0x12FC; // int32
    public const nint m_iPrimaryAddon = 0x1300; // int32
    public const nint m_iSecondaryAddon = 0x1304; // int32
    public const nint m_currentDeafnessFilter = 0x1308; // CUtlStringToken
    public const nint m_NumEnemiesKilledThisSpawn = 0x130C; // int32
    public const nint m_NumEnemiesKilledThisRound = 0x1310; // int32
    public const nint m_NumEnemiesAtRoundStart = 0x1314; // int32
    public const nint m_wasNotKilledNaturally = 0x1318; // bool
    public const nint m_vecPlayerPatchEconIndices = 0x131C; // uint32[5]
    public const nint m_iDeathFlags = 0x1330; // int32
    public const nint m_hPet = 0x1334; // CHandle< CChicken >
    public const nint m_unCurrentEquipmentValue = 0x1500; // uint16
    public const nint m_unRoundStartEquipmentValue = 0x1502; // uint16
    public const nint m_unFreezetimeEndEquipmentValue = 0x1504; // uint16
    public const nint m_nSurvivalTeamNumber = 0x1508; // int32
    public const nint m_bHasDeathInfo = 0x150C; // bool
    public const nint m_flDeathInfoTime = 0x1510; // float32
    public const nint m_vecDeathInfoOrigin = 0x1514; // Vector
    public const nint m_bKilledByHeadshot = 0x1520; // bool
    public const nint m_LastHitBox = 0x1524; // int32
    public const nint m_LastHealth = 0x1528; // int32
    public const nint m_flLastCollisionCeiling = 0x152C; // float32
    public const nint m_flLastCollisionCeilingChangeTime = 0x1530; // float32
