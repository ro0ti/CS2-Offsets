...
namespace CCSPlayerController {
    ...
    constexpr std::ptrdiff_t m_iRoundsWon = 0x824; // int32
...
namespace CCSPlayerPawn {
    ...
    constexpr std::ptrdiff_t m_nCharacterDefIndex = 0x1578; // uint16
    ...
    constexpr std::ptrdiff_t m_iRetakesOffering = 0x1660; // int32
    constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x1664; // int32
    constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x1668; // bool
    constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x1669; // bool
    constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x166C; // int32
    ...
    constexpr std::ptrdiff_t m_flLandseconds = 0x1678; // float32
    constexpr std::ptrdiff_t m_aimPunchAngle = 0x167C; // QAngle
    constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x1688; // QAngle
    constexpr std::ptrdiff_t m_aimPunchTickBase = 0x1694; // int32
    constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x1698; // float32
    ...
    constexpr std::ptrdiff_t m_iPlayerLocked = 0x1C38; // int32
    ...
    constexpr std::ptrdiff_t m_nRagdollDamageBone = 0x1C4C; // int32
...
namespace CCSPlayerPawnBase {
    ...
    constexpr std::ptrdiff_t m_flNameChangeHistory = 0xD4C; // float32[5]
    constexpr std::ptrdiff_t m_fLastGivenDefuserTime = 0xD60; // float32
    constexpr std::ptrdiff_t m_fLastGivenBombTime = 0xD64; // float32
    constexpr std::ptrdiff_t m_bHasNightVision = 0xD68; // bool
    constexpr std::ptrdiff_t m_bNightVisionOn = 0xD69; // bool
    constexpr std::ptrdiff_t m_fNextRadarUpdateTime = 0xD6C; // float32
    constexpr std::ptrdiff_t m_flLastMoneyUpdateTime = 0xD70; // float32
    constexpr std::ptrdiff_t m_MenuStringBuffer = 0xD74; // char[1024]
    constexpr std::ptrdiff_t m_fIntroCamTime = 0x1174; // float32
    constexpr std::ptrdiff_t m_nMyCollisionGroup = 0x1178; // int32
    constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x117C; // bool
    constexpr std::ptrdiff_t m_bKilledByTaser = 0x117D; // bool
    constexpr std::ptrdiff_t m_iMoveState = 0x1180; // int32
    ...
    constexpr std::ptrdiff_t m_nWhichBombZone = 0x1200; // int32
    constexpr std::ptrdiff_t m_bInBombZoneTrigger = 0x1204; // bool
    constexpr std::ptrdiff_t m_bWasInBombZoneTrigger = 0x1205; // bool
    constexpr std::ptrdiff_t m_iDirection = 0x1208; // int32
    constexpr std::ptrdiff_t m_iShotsFired = 0x120C; // int32
    constexpr std::ptrdiff_t m_ArmorValue = 0x1210; // int32
    constexpr std::ptrdiff_t m_flFlinchStack = 0x1214; // float32
    constexpr std::ptrdiff_t m_flVelocityModifier = 0x1218; // float32
    constexpr std::ptrdiff_t m_flHitHeading = 0x121C; // float32
    constexpr std::ptrdiff_t m_nHitBodyPart = 0x1220; // int32
    constexpr std::ptrdiff_t m_iHostagesKilled = 0x1224; // int32
    constexpr std::ptrdiff_t m_vecTotalBulletForce = 0x1228; // Vector
    constexpr std::ptrdiff_t m_flFlashDuration = 0x1234; // float32
    constexpr std::ptrdiff_t m_flFlashMaxAlpha = 0x1238; // float32
    constexpr std::ptrdiff_t m_flProgressBarStartTime = 0x123C; // float32
    constexpr std::ptrdiff_t m_iProgressBarDuration = 0x1240; // int32
    constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x1244; // bool
    constexpr std::ptrdiff_t m_flLowerBodyYawTarget = 0x1248; // float32
    constexpr std::ptrdiff_t m_bStrafing = 0x124C; // bool
    constexpr std::ptrdiff_t m_lastStandingPos = 0x1250; // Vector
    constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x125C; // float32
    ...
    constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x129C; // float32
    constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x12A0; // float32
    ...
    constexpr std::ptrdiff_t m_nNumDangerZoneDamageHits = 0x12E8; // int32
    ...
    constexpr std::ptrdiff_t m_nLastConcurrentKilled = 0x12F4; // int32
    constexpr std::ptrdiff_t m_nDeathCamMusic = 0x12F8; // int32
    constexpr std::ptrdiff_t m_iAddonBits = 0x12FC; // int32
    constexpr std::ptrdiff_t m_iPrimaryAddon = 0x1300; // int32
    constexpr std::ptrdiff_t m_iSecondaryAddon = 0x1304; // int32
    constexpr std::ptrdiff_t m_currentDeafnessFilter = 0x1308; // CUtlStringToken
    constexpr std::ptrdiff_t m_NumEnemiesKilledThisSpawn = 0x130C; // int32
    constexpr std::ptrdiff_t m_NumEnemiesKilledThisRound = 0x1310; // int32
    constexpr std::ptrdiff_t m_NumEnemiesAtRoundStart = 0x1314; // int32
    constexpr std::ptrdiff_t m_wasNotKilledNaturally = 0x1318; // bool
    constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x131C; // uint32[5]
    constexpr std::ptrdiff_t m_iDeathFlags = 0x1330; // int32
    constexpr std::ptrdiff_t m_hPet = 0x1334; // CHandle< CChicken >
    constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x1500; // uint16
    constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x1502; // uint16
    constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x1504; // uint16
    constexpr std::ptrdiff_t m_nSurvivalTeamNumber = 0x1508; // int32
    constexpr std::ptrdiff_t m_bHasDeathInfo = 0x150C; // bool
    constexpr std::ptrdiff_t m_flDeathInfoTime = 0x1510; // float32
    constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x1514; // Vector
    constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x1520; // bool
    constexpr std::ptrdiff_t m_LastHitBox = 0x1524; // int32
    constexpr std::ptrdiff_t m_LastHealth = 0x1528; // int32
    constexpr std::ptrdiff_t m_flLastCollisionCeiling = 0x152C; // float32
    constexpr std::ptrdiff_t m_flLastCollisionCeilingChangeTime = 0x1530; // float32
...
namespace CSAdditionalMatchStats_t {
    ...
    constexpr std::ptrdiff_t m_iNumSuicides = 0x38; // int32
    constexpr std::ptrdiff_t m_iNumTeamKills = 0x3C; // int32
    constexpr std::ptrdiff_t m_iTeamDamage = 0x40; // int32
}
