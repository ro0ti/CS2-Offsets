...
pub mod CCSPlayerController {
    ...
    pub const m_iRoundsWon: usize = 0x824; // int32
...
pub mod CCSPlayerPawn {
    ...
    pub const m_nCharacterDefIndex: usize = 0x1578; // uint16
    ...
    pub const m_iRetakesOffering: usize = 0x1660; // int32
    pub const m_iRetakesOfferingCard: usize = 0x1664; // int32
    pub const m_bRetakesHasDefuseKit: usize = 0x1668; // bool
    pub const m_bRetakesMVPLastRound: usize = 0x1669; // bool
    pub const m_iRetakesMVPBoostItem: usize = 0x166C; // int32
    ...
    pub const m_flLandseconds: usize = 0x1678; // float32
    pub const m_aimPunchAngle: usize = 0x167C; // QAngle
    pub const m_aimPunchAngleVel: usize = 0x1688; // QAngle
    pub const m_aimPunchTickBase: usize = 0x1694; // int32
    pub const m_aimPunchTickFraction: usize = 0x1698; // float32
    ...
    pub const m_iPlayerLocked: usize = 0x1C38; // int32
    ...
    pub const m_nRagdollDamageBone: usize = 0x1C4C; // int32
...
pub mod CCSPlayerPawnBase {
    ...
    pub const m_flNameChangeHistory: usize = 0xD4C; // float32[5]
    pub const m_fLastGivenDefuserTime: usize = 0xD60; // float32
    pub const m_fLastGivenBombTime: usize = 0xD64; // float32
    pub const m_bHasNightVision: usize = 0xD68; // bool
    pub const m_bNightVisionOn: usize = 0xD69; // bool
    pub const m_fNextRadarUpdateTime: usize = 0xD6C; // float32
    pub const m_flLastMoneyUpdateTime: usize = 0xD70; // float32
    pub const m_MenuStringBuffer: usize = 0xD74; // char[1024]
    pub const m_fIntroCamTime: usize = 0x1174; // float32
    pub const m_nMyCollisionGroup: usize = 0x1178; // int32
    pub const m_bInNoDefuseArea: usize = 0x117C; // bool
    pub const m_bKilledByTaser: usize = 0x117D; // bool
    pub const m_iMoveState: usize = 0x1180; // int32
    ...
    pub const m_nWhichBombZone: usize = 0x1200; // int32
    pub const m_bInBombZoneTrigger: usize = 0x1204; // bool
    pub const m_bWasInBombZoneTrigger: usize = 0x1205; // bool
    pub const m_iDirection: usize = 0x1208; // int32
    pub const m_iShotsFired: usize = 0x120C; // int32
    pub const m_ArmorValue: usize = 0x1210; // int32
    pub const m_flFlinchStack: usize = 0x1214; // float32
    pub const m_flVelocityModifier: usize = 0x1218; // float32
    pub const m_flHitHeading: usize = 0x121C; // float32
    pub const m_nHitBodyPart: usize = 0x1220; // int32
    pub const m_iHostagesKilled: usize = 0x1224; // int32
    pub const m_vecTotalBulletForce: usize = 0x1228; // Vector
    pub const m_flFlashDuration: usize = 0x1234; // float32
    pub const m_flFlashMaxAlpha: usize = 0x1238; // float32
    pub const m_flProgressBarStartTime: usize = 0x123C; // float32
    pub const m_iProgressBarDuration: usize = 0x1240; // int32
    pub const m_bWaitForNoAttack: usize = 0x1244; // bool
    pub const m_flLowerBodyYawTarget: usize = 0x1248; // float32
    pub const m_bStrafing: usize = 0x124C; // bool
    pub const m_lastStandingPos: usize = 0x1250; // Vector
    pub const m_ignoreLadderJumpTime: usize = 0x125C; // float32
    ...
    pub const m_flSlopeDropOffset: usize = 0x129C; // float32
    pub const m_flSlopeDropHeight: usize = 0x12A0; // float32
    ...
    pub const m_nNumDangerZoneDamageHits: usize = 0x12E8; // int32
    ...
    pub const m_nLastConcurrentKilled: usize = 0x12F4; // int32
    pub const m_nDeathCamMusic: usize = 0x12F8; // int32
    pub const m_iAddonBits: usize = 0x12FC; // int32
    pub const m_iPrimaryAddon: usize = 0x1300; // int32
    pub const m_iSecondaryAddon: usize = 0x1304; // int32
    pub const m_currentDeafnessFilter: usize = 0x1308; // CUtlStringToken
    pub const m_NumEnemiesKilledThisSpawn: usize = 0x130C; // int32
    pub const m_NumEnemiesKilledThisRound: usize = 0x1310; // int32
    pub const m_NumEnemiesAtRoundStart: usize = 0x1314; // int32
    pub const m_wasNotKilledNaturally: usize = 0x1318; // bool
    pub const m_vecPlayerPatchEconIndices: usize = 0x131C; // uint32[5]
    pub const m_iDeathFlags: usize = 0x1330; // int32
    pub const m_hPet: usize = 0x1334; // CHandle< CChicken >
    pub const m_unCurrentEquipmentValue: usize = 0x1500; // uint16
    pub const m_unRoundStartEquipmentValue: usize = 0x1502; // uint16
    pub const m_unFreezetimeEndEquipmentValue: usize = 0x1504; // uint16
    pub const m_nSurvivalTeamNumber: usize = 0x1508; // int32
    pub const m_bHasDeathInfo: usize = 0x150C; // bool
    pub const m_flDeathInfoTime: usize = 0x1510; // float32
    pub const m_vecDeathInfoOrigin: usize = 0x1514; // Vector
    pub const m_bKilledByHeadshot: usize = 0x1520; // bool
    pub const m_LastHitBox: usize = 0x1524; // int32
    pub const m_LastHealth: usize = 0x1528; // int32
    pub const m_flLastCollisionCeiling: usize = 0x152C; // float32
    pub const m_flLastCollisionCeilingChangeTime: usize = 0x1530; // float32
